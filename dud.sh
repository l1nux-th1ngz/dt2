...
# Install Budgie desktop and suggested packages
sudo apt-get install -y budgie-desktop
sudo apt-get install --install-suggests budgie-desktop -y
sleep 2
...
sudo apt-get install -y mpv figlet qimgv l3afpad  redshift cpu-x  wmctrl dnsutils whois curl
